...
function App() {
  ...
  return (
    <main className="h-dvh max-h-dvh overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 flex h-full w-full justify-center p-3 sm:p-4">
        <div className="grid h-full w-full max-w-full grid-rows-[auto_minmax(0,1fr)] gap-3 sm:gap-4 lg:w-auto">
          ...
          <div className="grid min-h-0 items-stretch gap-3 sm:gap-4 lg:grid-cols-[auto_minmax(300px,360px)]">
