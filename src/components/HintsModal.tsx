          ...
          <div className="grid gap-3 md:grid-cols-2">
            <section className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
              ...
              <ul className="space-y-2 text-sm leading-5 text-slate-300">
                ...
                <li className="flex gap-2"><Shield size={16} className="mt-0.5 shrink-0 text-emerald-200" /> During turns 1-4, you cannot place next to your own piece in any direction.</li>
