...
export function BoardCell({ cell, isSelected, currentPlayer, onSelect }: BoardCellProps) {
  ...
  return (
    <button
      ...
      className={[
        'group relative h-full w-full min-h-0 overflow-hidden rounded-xl border bg-slate-950/80 transition duration-200 ease-out [container-type:inline-size] sm:rounded-2xl',
    ...
    >
      ...
      {cell.piece && (
        <span
          className={[
            'pointer-events-none absolute inset-0 z-10 flex select-none items-center justify-center font-display text-[78cqw] font-black leading-none tracking-[-0.06em]',
            cell.piece === 'X'
